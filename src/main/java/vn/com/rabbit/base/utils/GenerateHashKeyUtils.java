...
public class GenerateHashKeyUtils {
     ...
     * @param data   content
     * @return key
     * @throws SignatureException failed to generate HMAC
     */
    public String generateHmacSHA512(String secret, String data) throws SignatureException {
        try {
     ...
     * @param data content
     * @return key
     * @throws SignatureException failed to generate SHA256
     */
    public String generateSHA256(String data) throws SignatureException {
        try {
